...
*/
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            if metadataObj.stringValue != nil {
                ...
                //AddItemTableViewController.barcodeString = metadataObj.stringValue
                //ViewController.itemNameTextField = nameString
                //ViewController.itemNumTextField = numString
                ...
                //self.present(AddItemTableViewController, animated: true, completion: nil)
            }
        }
    }
    ...
    /*
    func displayAddItemViewController(barcodeString: String){
                // Pass bacode string to ViewController
                let AddItemTableViewController = storyboard?.instantiateViewController(withIdentifier: "Add New Item") as! AddItemTableViewController
                AddItemTableViewController.barcodeString = barcodeString
                //closure
        /*
        if(clickClosure != nil){
            clickClosure!(ItemNameString)
        }
        */
        
        if postValueBlock != nil {
            postValueBlock!(ItemNameString)
        }
